        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-emerald-400 font-medium mb-4">Small Business CRM</p>
                <h1 className="text-4xl sm:text-6xl font-bold leading-tight mb-6">
                  Track incoming leads and turn more enquiries into paying work.
                </h1>
                <p className="text-lg sm:text-xl text-zinc-300 leading-8 max-w-2xl mb-8">
                  RealQte CRM helps small businesses manage quote requests, update lead statuses, and move prospects toward quotes, invoices, and sales.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-white font-semibold">See incoming leads in one place</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 2</p>
                    <p className="text-white font-semibold">Update statuses and track movement</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 3</p>
                    <p className="text-white font-semibold">Create quotes from leads faster</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[32px] p-6">
                <div className="grid gap-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">Small Business CRM</h3>
                    <p className="text-zinc-300 leading-7">
                      Small businesses, contractors, agencies, consultants, and service providers
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Capture enquiries</h3>
              <p className="text-zinc-400">Use your mini website and public business page to receive quote requests.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">02</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Track lead status</h3>
              <p className="text-zinc-400">Move leads from new to quoted, won, lost, or repeat.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">03</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Create quotes faster</h3>
              <p className="text-zinc-400">Use the lead information to start the quote workflow with more context.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">04</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Build a cleaner pipeline</h3>
              <p className="text-zinc-400">Keep follow-ups and customer opportunities more organised as your business grows.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid gap-4">
            <div key="1" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">What is a small business CRM?</h3>
              <p className="text-zinc-400 leading-7">A small business CRM helps you manage leads, customer enquiries, and follow-ups in a more structured way.</p>
            </div>
            <div key="2" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Does RealQte CRM work with the mini website builder?</h3>
              <p className="text-zinc-400 leading-7">Yes. RealQte is building that workflow so quote requests can support a broader business process.</p>
            </div>
            <div key="3" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can CRM help me quote faster?</h3>
              <p className="text-zinc-400 leading-7">Yes. A cleaner lead workflow makes it easier to move from enquiry to quote.</p>
            </div>
            <div key="4" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Is CRM only for big companies?</h3>
              <p className="text-zinc-400 leading-7">No. Small businesses often benefit the most from simple, easy-to-use CRM tools.</p>
            </div>
          </div>
        </section>
