...
export const metadata: Metadata = {
  title: 'Free Invoice Generator for Small Businesses | RealQte',
  description: 'Create professional invoices online with RealQte. Built for freelancers, contractors, service businesses, and small teams that need fast, polished invoicing.',
  alternates: {
    canonical: 'https://realqte.com/invoice-generator',
  },
  openGraph: {
    title: 'Free Invoice Generator for Small Businesses | RealQte',
    description: 'Create professional invoices online with RealQte. Built for freelancers, contractors, service businesses, and small teams that need fast, polished invoicing.',
    url: 'https://realqte.com/invoice-generator',
    siteName: 'RealQte',
    type: 'website',
  },
  twitter: {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-emerald-400 font-medium mb-4">Invoice Generator</p>
                <h1 className="text-4xl sm:text-6xl font-bold leading-tight mb-6">
                  Create professional invoices faster and look more credible.
                </h1>
                <p className="text-lg sm:text-xl text-zinc-300 leading-8 max-w-2xl mb-8">
                  RealQte helps small businesses generate polished invoices, save customer details, reuse products and services, and keep billing organised in one place.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-white font-semibold">Generate clean, branded invoices</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 2</p>
                    <p className="text-white font-semibold">Save customers and products</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 3</p>
                    <p className="text-white font-semibold">Track sent, unpaid, and paid invoices</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[32px] p-6">
                <div className="grid gap-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">Invoice Generator</h3>
                    <p className="text-zinc-300 leading-7">
                      Freelancers, contractors, service businesses, suppliers, and growing teams
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Set up your business</h3>
              <p className="text-zinc-400">Add your business details, logo, and contact information so every invoice looks professional.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">02</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Create your invoice</h3>
              <p className="text-zinc-400">Add your client, line items, totals, and notes in a clean invoice workflow.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">03</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Send and track</h3>
              <p className="text-zinc-400">Share the invoice, track statuses, and keep your document history organised.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">04</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Upgrade when ready</h3>
              <p className="text-zinc-400">Unlock unlimited workflow tools, reporting, and broader business features as you grow.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid gap-4">
            <div key="1" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can I use RealQte as an online invoice generator?</h3>
              <p className="text-zinc-400 leading-7">Yes. RealQte lets you create polished invoices online and keep them organised in one platform.</p>
            </div>
            <div key="2" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Is it good for small businesses?</h3>
              <p className="text-zinc-400 leading-7">Yes. RealQte is built for small businesses that need a simple and professional invoicing workflow.</p>
            </div>
            <div key="3" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can I reuse customers and products?</h3>
              <p className="text-zinc-400 leading-7">Yes. You can save customer and product details to make future invoices faster.</p>
            </div>
            <div key="4" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Does RealQte only work in South Africa?</h3>
              <p className="text-zinc-400 leading-7">No. RealQte is positioning for a broader global market and can support international small business workflows.</p>
            </div>
          </div>
        </section>
