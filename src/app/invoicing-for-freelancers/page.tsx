        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-emerald-400 font-medium mb-4">Invoicing for Freelancers</p>
                <h1 className="text-4xl sm:text-6xl font-bold leading-tight mb-6">
                  Invoice your freelance work with more confidence and less admin.
                </h1>
                <p className="text-lg sm:text-xl text-zinc-300 leading-8 max-w-2xl mb-8">
                  RealQte helps freelancers create polished invoices, reuse client details, and keep projects, quotes, and billing more organised.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-white font-semibold">Cleaner freelance invoices</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 2</p>
                    <p className="text-white font-semibold">Simple client and service reuse</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 3</p>
                    <p className="text-white font-semibold">Professional presentation for solo operators</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[32px] p-6">
                <div className="grid gap-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">Invoicing for Freelancers</h3>
                    <p className="text-zinc-300 leading-7">
                      Designers, developers, consultants, writers, marketers, coaches, and solo businesses
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              ...
              <p className="text-zinc-400">Add your business name, contact details, and branding.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">02</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Create the invoice</h3>
              <p className="text-zinc-400">Add your client, services, totals, and notes in a clean invoice builder.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">03</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Keep work organised</h3>
              <p className="text-zinc-400">Track past invoices and keep records in one place.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">04</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Grow into more tools</h3>
              <p className="text-zinc-400">Use quotes, mini websites, and CRM features as your freelance business grows.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid gap-4">
            <div key="1" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Is RealQte good for freelancers?</h3>
              <p className="text-zinc-400 leading-7">Yes. It is built to help small operators create professional documents faster.</p>
            </div>
            <div key="2" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can I use RealQte for both quotes and invoices?</h3>
              <p className="text-zinc-400 leading-7">Yes. The platform supports both.</p>
            </div>
            <div key="3" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Do I need accounting software to start?</h3>
              <p className="text-zinc-400 leading-7">No. RealQte is meant to simplify day-to-day document workflows.</p>
            </div>
            <div key="4" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can it help me look more professional with clients?</h3>
              <p className="text-zinc-400 leading-7">Yes. Better-looking documents can improve trust and presentation.</p>
            </div>
          </div>
        </section>
