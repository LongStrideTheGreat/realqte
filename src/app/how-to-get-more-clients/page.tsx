...
export const metadata: Metadata = {
  title: 'How to Get More Clients as a Small Business | RealQte',
  description: 'Learn practical ways to get more clients as a small business and use RealQte tools like mini websites, quotes, invoices, and CRM to support growth.',
  alternates: {
    canonical: 'https://realqte.com/how-to-get-more-clients',
  },
  openGraph: {
    title: 'How to Get More Clients as a Small Business | RealQte',
    description: 'Learn practical ways to get more clients as a small business and use RealQte tools like mini websites, quotes, invoices, and CRM to support growth.',
    url: 'https://realqte.com/how-to-get-more-clients',
    siteName: 'RealQte',
    type: 'website',
  },
  twitter: {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-emerald-400 font-medium mb-4">Business Growth Guide</p>
                <h1 className="text-4xl sm:text-6xl font-bold leading-tight mb-6">
                  How to get more clients and turn more enquiries into real work.
                </h1>
                <p className="text-lg sm:text-xl text-zinc-300 leading-8 max-w-2xl mb-8">
                  Getting more clients is not only about marketing. It is also about looking professional, responding faster, and making it easier for prospects to trust your business.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-white font-semibold">Look more credible online</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 2</p>
                    <p className="text-white font-semibold">Make enquiry and quote flow easier</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 3</p>
                    <p className="text-white font-semibold">Follow up better with CRM</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[32px] p-6">
                <div className="grid gap-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">Business Growth Guide</h3>
                    <p className="text-zinc-300 leading-7">
                      Small businesses, freelancers, contractors, consultants, and local service providers
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Improve first impressions</h3>
              <p className="text-zinc-400">Use cleaner quotes, invoices, and a public mini website to look more established.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">02</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Make contact easier</h3>
              <p className="text-zinc-400">Give prospects a direct way to contact you and request quotes.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">03</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Respond faster</h3>
              <p className="text-zinc-400">Use saved details and a structured workflow to quote more quickly.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">04</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Track opportunities</h3>
              <p className="text-zinc-400">Use CRM-style tools to manage leads and follow up more consistently.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid gap-4">
            <div key="1" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">How can a small business get more clients?</h3>
              <p className="text-zinc-400 leading-7">Improving trust, speed, and follow-up can help you convert more enquiries into paying work.</p>
            </div>
            <div key="2" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">What role does a mini website play?</h3>
              <p className="text-zinc-400 leading-7">A mini website gives prospects a simple public page where they can learn about your business and request quotes.</p>
            </div>
            <div key="3" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">How does CRM help?</h3>
              <p className="text-zinc-400 leading-7">CRM helps you keep track of leads, follow-ups, and progress instead of losing opportunities.</p>
            </div>
            <div key="4" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can RealQte support this workflow?</h3>
              <p className="text-zinc-400 leading-7">Yes. RealQte is expanding beyond quotes and invoices into mini websites and CRM support.</p>
            </div>
          </div>
        </section>
