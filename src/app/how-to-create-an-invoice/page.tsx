...
export const metadata: Metadata = {
  title: 'How to Create an Invoice for Small Business | RealQte',
  description: 'Learn how to create a professional invoice for your small business and use RealQte to make the process faster and more organised.',
  alternates: {
    canonical: 'https://realqte.com/how-to-create-an-invoice',
  },
  openGraph: {
    title: 'How to Create an Invoice for Small Business | RealQte',
    description: 'Learn how to create a professional invoice for your small business and use RealQte to make the process faster and more organised.',
    url: 'https://realqte.com/how-to-create-an-invoice',
    siteName: 'RealQte',
    type: 'website',
  },
  twitter: {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-emerald-400 font-medium mb-4">How to Create an Invoice</p>
                <h1 className="text-4xl sm:text-6xl font-bold leading-tight mb-6">
                  How to create an invoice that looks professional and gets sent faster.
                </h1>
                <p className="text-lg sm:text-xl text-zinc-300 leading-8 max-w-2xl mb-8">
                  A good invoice should be clear, accurate, and easy for your client to understand. RealQte helps small businesses create cleaner invoices with less manual work.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-white font-semibold">Know what to include</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 2</p>
                    <p className="text-white font-semibold">Use a cleaner invoicing workflow</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 3</p>
                    <p className="text-white font-semibold">Keep records more organised</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[32px] p-6">
                <div className="grid gap-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">How to Create an Invoice</h3>
                    <p className="text-zinc-300 leading-7">
                      Small businesses, freelancers, contractors, and service providers
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              ...
              <p className="text-zinc-400">Include your business name, contact details, and branding.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">02</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Add client details</h3>
              <p className="text-zinc-400">Make sure the customer or company information is clear and correct.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">03</div>
              <h3 className="text-xl font-semibold mb-3 text-white">List the work or products</h3>
              <p className="text-zinc-400">Add item descriptions, quantities, rates, totals, and notes.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">04</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Send and save properly</h3>
              <p className="text-zinc-400">Keep your invoice stored in a cleaner workflow so you can find it later.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid gap-4">
            <div key="1" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">What should an invoice include?</h3>
              <p className="text-zinc-400 leading-7">An invoice should include your business details, client details, item descriptions, totals, and any important notes.</p>
            </div>
            <div key="2" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Why use software instead of doing it manually?</h3>
              <p className="text-zinc-400 leading-7">Software helps you save time, reduce mistakes, and look more professional.</p>
            </div>
            <div key="3" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can RealQte help me create invoices faster?</h3>
              <p className="text-zinc-400 leading-7">Yes. It is designed to simplify invoice creation for small businesses.</p>
            </div>
            <div key="4" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Is this useful for freelancers and contractors too?</h3>
              <p className="text-zinc-400 leading-7">Yes. The same invoicing principles apply across many service-based businesses.</p>
            </div>
          </div>
        </section>
