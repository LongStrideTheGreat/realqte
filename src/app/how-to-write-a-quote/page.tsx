...
export const metadata: Metadata = {
  title: 'How to Write a Business Quote | RealQte',
  description: 'Learn how to write a professional business quote and use RealQte to create cleaner, faster quotes for your clients.',
  alternates: {
    canonical: 'https://realqte.com/how-to-write-a-quote',
  },
  openGraph: {
    title: 'How to Write a Business Quote | RealQte',
    description: 'Learn how to write a professional business quote and use RealQte to create cleaner, faster quotes for your clients.',
    url: 'https://realqte.com/how-to-write-a-quote',
    siteName: 'RealQte',
    type: 'website',
  },
  twitter: {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-emerald-400 font-medium mb-4">How to Write a Quote</p>
                <h1 className="text-4xl sm:text-6xl font-bold leading-tight mb-6">
                  How to write a quote that looks professional and helps clients decide faster.
                </h1>
                <p className="text-lg sm:text-xl text-zinc-300 leading-8 max-w-2xl mb-8">
                  A clear, professional quote can improve trust and make it easier for clients to say yes. RealQte helps businesses build cleaner quotes without the usual friction.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-white font-semibold">Know what a good quote includes</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 2</p>
                    <p className="text-white font-semibold">Use cleaner quote structure</p>
                  </div>
                  <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-4">
                    <p className="text-zinc-500 text-xs uppercase tracking-[0.14em] mb-2">Benefit 3</p>
                    <p className="text-white font-semibold">Speed up your workflow over time</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[32px] p-6">
                <div className="grid gap-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">How to Write a Quote</h3>
                    <p className="text-zinc-300 leading-7">
                      Small businesses, contractors, freelancers, consultants, and service providers
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Start with business details</h3>
              <p className="text-zinc-400">Add your branding and contact details so the quote feels credible.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">02</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Add the client information</h3>
              <p className="text-zinc-400">Make sure the customer details are correct and easy to identify.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">03</div>
              <h3 className="text-xl font-semibold mb-3 text-white">List the work clearly</h3>
              <p className="text-zinc-400">Break down services, products, or labour so the client understands the quote.</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="text-emerald-400 text-3xl font-bold mb-4">04</div>
              <h3 className="text-xl font-semibold mb-3 text-white">Add totals and notes</h3>
              <p className="text-zinc-400">Include totals, validity, and any notes that help the client make a decision.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 border-t border-zinc-800">
          ...
          <div className="grid gap-4">
            <div key="1" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">What should a quote include?</h3>
              <p className="text-zinc-400 leading-7">A quote should include your business details, client details, the work being quoted, totals, and any relevant notes.</p>
            </div>
            <div key="2" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Why does quote presentation matter?</h3>
              <p className="text-zinc-400 leading-7">A clean quote can build trust and improve how professional your business looks.</p>
            </div>
            <div key="3" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Can RealQte help me quote faster?</h3>
              <p className="text-zinc-400 leading-7">Yes. It helps you create professional quotes with a more structured workflow.</p>
            </div>
            <div key="4" className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">Is this useful for service businesses?</h3>
              <p className="text-zinc-400 leading-7">Yes. RealQte is especially relevant to businesses that quote labour, services, projects, and custom work.</p>
            </div>
          </div>
        </section>
